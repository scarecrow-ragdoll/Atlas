...
| ID | Wave | Scope | Severity | Parent | Question | Why It Matters | Needed Answer | Source Or Report | Status | Resolution |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| DQ-W09-002 | WAVE-09 | product-ac | WATCHLIST | Q-AC-16 | CSV files in backup — mandatory or optional? | Affects ZIP content generation | Confirm: exclude CSV | planner/product-ac | open | Recommended: exclude |
| DQ-W09-003 | WAVE-09 | data-integration-ops | WATCHLIST | — | Import ZIP upload size limit | MaxBytesReader config parameter | Max size in MB | planner/data-integration-ops | open | Recommended: 500MB |
| DQ-W09-004 | WAVE-09 | security-privacy-compliance | WATCHLIST | — | Should backup/import operations be logged differently than AI export? | Privacy compliance (AC-117-120) | Confirm: log event metadata only (not content) | planner/security-compliance | open | Recommended: log event metadata only |
## Deferred
None.
## Watchlist
